...
(async () => {
  console.log('╔════════════════════════════════════════════════════════════╗');
  console.log('║  TESTE GATEWAY - VALORES NOVOS (66.20 e 72.40)             ║');
  console.log('╚════════════════════════════════════════════════════════════╝\n');
  
  console.log('Testando geração de PIX na gateway...\n');
  
  await testarPix(66.20, 'Teste Cliente 1');
  await new Promise(r => setTimeout(r, 2000));
  
  await testarPix(72.40, 'Teste Cliente 2');
